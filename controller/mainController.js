app.controller("mainController", function ($scope) {
    ...
    function bindData(data) {
        ...
        $scope.programing_skills = data.programing_skills;
    ...
    $scope.renderSkillsDone = function() {
        enableRadialProgress();
    };

    $scope.imageRenderDone = function () {
        console.log("imageRenderDone");
